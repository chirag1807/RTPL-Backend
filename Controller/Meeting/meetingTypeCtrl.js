  ...
  try {
    ...
    if (req.params && req.body) {
      ...
      if (updatedMeetingType) {
        res
          .status(200)
          .json({ message: "Meeting Type has been Updated Successfully." });
      } else {
        res
          .status(400)
          .json({
            message:
              "Meeting Type has not been Updated, Please Try Again Later.",
          });
      }
    } else {
      console.log("Invalid perameter");
  ...
  try {
    ...
    if (req.params) {
      ...
      if (deletedMeetingType) {
        res
          .status(200)
          .json({ message: "Meeting Type has been Deleted Successfully." });
      } else {
        res
          .status(400)
          .json({
            message:
              "Meeting Type has not been Deleted, Please Try Again Later.",
          });
      }
    } else {
      console.log("Invalid perameter");
